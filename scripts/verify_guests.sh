...
STRICT="msvcrt_boot wstest wsprintf_boot wsp_min2 godot_path wfopen_path ucrt_wide kernel32_mapfile reg_create_delete crt_runtime vsnprintf_test loadstring rtl_helpers user32_dialog oleaut_variant gdi_text_w"
