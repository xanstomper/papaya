# Project Papaya - ARM Steam Compatibility Layer

**Papaya** is a high-performance compatibility runtime and optimization stack written in **C++23** designed to emulate and run **Windows Steam games on ARM Android handhelds (Snapdragon 8 Gen 2/3, AYN Odin 2, Retroid Pocket), single-board computers (Raspberry Pi 5 / BCM2712), and Linux devices (Steam Deck, Ubuntu, Arch)**.

---

## The 4-Layer Translation & Optimization Stack
...
+---------------------------------------------------------------------------------------------------------+
|                                                                                                         |
|  1. Steamworks API Stub & DRM Bypass (papaya-steam)                                                     |
...
|                                                                                                         |
|  2. CPU Dynamic Recompiler & 16KB Page Bridge (papaya-cpu)                                              |
...
|                                                                                                         |
|  3. Potato Mode Graphics Interceptor (papaya-gpu)                                                       |
...
|                                                                                                         |
|  4. Hardware Profiler, Spoofing & Memory Watchdog (papaya-profile)                                      |
...
|                                                                                                         |
|  5. OS Bridge, NTSync & io_uring Direct I/O (papaya-kernel)                                            |
...
|                                                                                                         |
|  6. Audio & Input Subsystems (papaya-audio & papaya-input)                                              |
